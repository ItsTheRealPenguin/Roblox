if _G.___threadUI then task.cancel( _G.___threadUI ) end;
local ___UI_PATH = gethui() if ___UI_PATH.ui then ___UI_PATH.ui:Destroy() end;
...
ui.Name = "ui"
ui.Parent = ___UI_PATH
ui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

_G.___threadUI = task.spawn(function()
    while wait() do
